  ...
  return (
    <main>
      <nav className="nav shell" aria-label="Main navigation">
        ...
        <a className="navCta" href="/monitor">Open monitor <span>↗</span></a>
      </nav>
      ...
      <section className="cta"><div className="shell"><span className="kicker">FROM HEADLINE TO EXPOSURE MAP</span><h2>Stop tracking news.<br /><em>Start tracking narrative risk.</em></h2><a className="primary lightBtn" href="/monitor">Launch Ghost Monitor <span>↗</span></a></div></section>
